...
public class FirmwareHeaderPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    private static final String KEY_DEVICE_MAINTAINER_PROP = "ro.device.maintainer";
    private static final String KEY_DEVICE_MAINTAINER_LINK_PROP = "ro.device.maintainer_link";

    private static final Uri ROM_URI_DATA = Uri.parse("https://arrowos.net");
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        androidVersionSummary.setText(getAndroidVersionSummary() + " (Tiramisu)");
